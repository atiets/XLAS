...
classes = None
with open('./train/model/Objectdetection/object_detection_classes_yolov4.txt', 'rt') as f:
...
try:
      ...
      st.session_state["Net"] = cv2.dnn.readNet('./train/model/Objectdetection/yolov4.weights', './train/model/Objectdetection/yolov4.cfg')
